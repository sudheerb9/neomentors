...
export default function ChargeLimitsScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TextInput label="Maximum Amperage while charging [A]" mode="outlined" value="0" style={styles.textInput} />
      
      <View style={styles.checkboxView}>
        <Checkbox status={checked ? 'checked' : 'unchecked'} onPress={() => { setChecked(!checked); }} />
        <Text> Stop all charging when SOC reaches &emsp;</Text>
        <TextInput mode="outlined" value="95" style={styles.timeInput} />
      </View>

      <Text style={styles.heading}>{'\n'}State of Charge Derate Settings :</Text>
      <TextInput label="Start reducing current limit at (% state of charge) " mode="outlined" value="95" style={styles.textInput} />
      <TextInput label="Reduce maximum possible limit by (Amps per % SOC)" mode="outlined" value="8" style={styles.textInput} />
      <View style={styles.checkboxView}>
        <Checkbox status={checked2 ? 'checked' : 'unchecked'} onPress={() => { setChecked2(!checked2); }} />
        <Text> Reduce Current Limit due to SOC when charge power is ON &emsp;</Text>
      </View>
